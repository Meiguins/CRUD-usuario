...
import com.meiguins.usuario.api.request.EnderecoRequestDTO;
...
public class UsuarioConverter {
    ...
    public UsuarioEntity paraUsuarioEntity(UsuarioRequestDTO usuarioDTO) {return UsuarioEntity.builder()
